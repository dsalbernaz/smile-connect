...
export function WhatsAppButton({
  ...
  size?: "default" | "large" | "fixed";
  className?: string;
  href?: string;
  label?: string;
}) {
  const base =
    "inline-flex items-center justify-center gap-2 rounded-full font-semibold text-white transition-all duration-200 hover:scale-105 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#128C7E]";
  const sizes = {
